    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[#333] bg-[#1b1b1b] px-3 py-2 font-sans text-xs text-[#d4d4d4]">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold">Excalidraw board</span>
          <span
        ...
        <div className="flex items-center gap-1.5">
          ...
          {sessionId && !readOnly && (
            <button
              ...
              className="flex items-center gap-1 rounded-md bg-[#2A9D7B] px-2.5 py-1.5 text-[11px] font-semibold text-white transition hover:bg-[#238266] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#7ee0c5]"
            >
          ...
          <button
            type="button"
            onClick={onUseLegacyBoard}
            className="rounded-md px-2.5 py-1.5 text-[11px] text-[#aaa] transition hover:bg-[#303030] hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#7ee0c5]"
          >
            Use legacy board
          </button>
        </div>
